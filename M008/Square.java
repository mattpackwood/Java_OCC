...
public class Square extends Shape
{
	...
	gpx.fillRect (getXCoord()-(getWidth()/2),getYCoord()-(getHeight()/2),getWidth(),getHeight());  // this is the only unique part of the class's methods
	}
